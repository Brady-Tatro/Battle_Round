  ...
  def to_wound
    if @hits > 0
      ...
      if @weapon_strength >= @toughness * 2
        ...
        @wounds.flatten.delete_if { |wound| wound < 2 }
        ...
        @wounds.flatten.delete_if { |wound| wound < 3 }
        ...
        @wounds.flatten.delete_if { |wound| wound < 4 }
        ...
        @wounds.flatten.delete_if { |wound| wound < 6 }
        ...
        @wounds.flatten.delete_if { |wound| wound < 5 }
      end
